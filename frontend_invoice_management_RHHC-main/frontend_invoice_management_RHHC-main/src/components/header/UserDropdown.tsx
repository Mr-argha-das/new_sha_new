    ...
    <div className="relative">
      ...
      >
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b border-gray-200 dark:border-gray-800">
          <PagePermissionGuard fallback="" permissions={['user-management/profile:write']}>
            <li>
              <DropdownItem
          ...
          <PagePermissionGuard fallback="" permissions={'accountSetting-management/accountSetting:read'}>
            <li>
              <DropdownItem
                onItemClick={closeDropdown}
                tag="a"
